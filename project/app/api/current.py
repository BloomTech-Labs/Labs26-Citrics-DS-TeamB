...
DATA_FILEPATH1 = os.path.join(os.path.dirname(__file__), "..", "..","data", "current_city_metrics.csv")
DATA_FILEPATH2 = os.path.join(os.path.dirname(__file__), "..", "..","data", "historical_pop_data_final.csv")
DATA_FILEPATH3 = os.path.join(os.path.dirname(__file__), "..", "..","data", "6yr_city_unemployment_data.csv")

@router.get('/combined_metrics_current/{city_id}')
async def metrics_to_dict(city_id: int):
    ...
    rt_data_dict["areaname"] = rt_data[0][4]
    rt_data_dict["countyname"] = rt_data[0][5]
    rt_data_dict["total_pop"] = rt_data[0][6]
    rt_data_dict["land_area"] = rt_data[0][7]
    rt_data_dict["pop_density"] = rt_data[0][8]
    rt_data_dict["male_pop"] = rt_data[0][9]
    rt_data_dict["female_pop"] = rt_data[0][10]
    rt_data_dict["age_under_20"] = rt_data[0][11]
    rt_data_dict["age_20-29"] = rt_data[0][12]
    rt_data_dict["age_30-39"] = rt_data[0][13]
    rt_data_dict["age_40-49"] = rt_data[0][14]
    rt_data_dict["age_50-59"] = rt_data[0][15]
    rt_data_dict["age_above_60"] = rt_data[0][16]
    rt_data_dict["unemployment_rate"] = rt_data[0][17]
    rt_data_dict["rank"] = rt_data[0][18]
    rt_data_dict["fmr_0"] = rt_data[0][19]
    rt_data_dict["fmr_1"] = rt_data[0][20]
    rt_data_dict["fmr_2"] = rt_data[0][21]
    rt_data_dict["fmr_3"] = rt_data[0][22]
    rt_data_dict["fmr_4"] = rt_data[0][23]
    rt_data_dict["fmr_pct_chg"] = rt_data[0][24]
    rt_data_dict["fmr_dollar_chg"] = rt_data[0][25]
    rt_data_dict["summer_maxtempF_mean"] = rt_data[0][26]
    rt_data_dict["summer_mintempF_mean"] = rt_data[0][27]
    rt_data_dict["summer_humidity_mean"] = rt_data[0][28]
    rt_data_dict["winter_maxtempF_mean"] = rt_data[0][29]
    rt_data_dict["winter_mintempF_mean"] = rt_data[0][30]
    rt_data_dict["winter_humidity_mean"] = rt_data[0][31]
    rt_data_dict["total_days_snowed"] = rt_data[0][32]
